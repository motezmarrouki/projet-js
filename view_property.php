   ...
   <div class="details">
     <div class="swiper images-container">
         <div class="swiper-wrapper">
            ...
            <img src="uploaded_files/<?= $fetch_property['image_0'.$i]; ?>" alt="" class="swiper-slide">
            <?php endif; ?>
            <?php endfor; ?>
         </div>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i>deposit amount : </i><span><i class="fas fa-indian-rupee-sign" style="margin-right: .5rem;"></i><?= $fetch_property['deposite']; ?></span></p>
      ...
      <div class="flex">
         ...
         ?>
         <div class="box">
            <?php foreach($amenities1 as $amenity): ?>
            <p><i class="fas fa-<?= ($fetch_property[$amenity] == 'yes') ? 'check' : 'times'; ?>"></i><span><?= str_replace('_',' ', $amenity); ?></span></p>
            <?php endforeach; ?>
         </div>
         <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="reservation.php?property_id=<?= $property_id; ?>" class="btn">Reserve</a>
      </form>
   </div>
   <?php
      }
